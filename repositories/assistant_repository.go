...
func (r *assistantRepository) GetAssistantById(id uint) (*models.Assistant, error) {
	...
	}).Preload("AssistantPosition").Preload("AssistantPosition.Position").Preload("TeachingHistory.Period").Preload("TeachingHistory.Course").Preload("AssistantSocialMedia").Preload("AssistantSocialMedia").First(&assistant, id).Error
